...
INSERT INTO `administradores` VALUES (1,'Administrador EcoLaço','admin@ecolaco.com','$2y$10$EyHyBjSln.9bajZO6cvsbuuMUMOayUPwfO5Sa0kvQFlefxHCZAFsa',1,'2026-08-15 23:24:24','2026-08-15 23:36:51');
...
INSERT INTO `historico_envios` VALUES (11,1,'comunicado','Comunicado: Alteração na coleta do Centro durante feriado','pendente',NULL,'2026-08-16 00:27:09','2026-08-16 00:27:09'),(10,1,'campanha','Campanha: Mutirão de Reciclagem - Praça Rui Barbosa','pendente',NULL,'2026-08-16 00:27:09','2026-08-16 00:27:09'),(9,1,'coleta','Atualização de coleta: Centro - Regular - SEGUNDA-QUARTA-SEXTA','pendente',NULL,'2026-08-16 00:27:09','2026-08-16 00:27:09');
...
CREATE TABLE `notificacoes` (
  ...
  `tipo_usuario` enum('admin','prefeitura') NOT NULL,
  `titulo` varchar(200) NOT NULL,
  `mensagem` text NOT NULL,
  `tipo` enum('sucesso','erro','aviso','info') NOT NULL DEFAULT 'info',
...
INSERT INTO `prefeituras` VALUES (1,1,'Prefeitura Municipal de Jacarezinho','00.000.000/0001-00','prefeitura@jacarezinho.pr.gov.br','(43) 9999-9999',NULL,NULL,'ativo',1,'2026-08-15 01:56:30','2026-08-15 01:56:30'),(2,1,'Prefeitura de Teste Pendente','11.111.111/0001-11','teste@prefeitura.com','(43) 9999-8888',NULL,NULL,'inativo',1,'2026-08-16 00:00:47','2026-08-16 00:05:34'),(3,1,'Prefeitura Teste 2','22.222.222/0001-22','teste2@prefeitura.com',NULL,NULL,NULL,'ativo',1,'2026-08-16 00:07:48','2026-08-16 00:08:19');
...
INSERT INTO `usuarios_prefeitura` VALUES (2,1,'admin@jacarezinho.pr.gov.br','$2y$10$ppvZL5RLPDUCbT5.y9e9hOjd5OgjnpACH.wpN561wNYnNRlyt6JYO','2026-08-16 01:41:39',1,'2026-08-15 02:00:55','2026-08-16 04:41:39');
...
-- Dump completed on 2026-08-16  1:59:41
